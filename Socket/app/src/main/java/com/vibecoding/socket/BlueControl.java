    ...
    private void thietBi1() {
        if (btSocket != null) {
            try {
                if (this.flaglamp1 == 0) {
                    this.flaglamp1 = 1;
                    this.btnTb1.setBackgroundResource(R.drawable.button_on);
                    ...
                    this.flaglamp1 = 0;
                    this.btnTb1.setBackgroundResource(R.drawable.button_off);
    ...
    private void thietBi2() {
        if (btSocket != null) {
            try {
                if (this.flaglamp2 == 0) {
                    this.flaglamp2 = 1;
                    this.btnTb2.setBackgroundResource(R.drawable.button_on);
                    ...
                    this.flaglamp2 = 0;
                    this.btnTb2.setBackgroundResource(R.drawable.button_off);
